...
//=================================================================//
    ...
    #define  BG_SPI_SR          SPSR0
     ...
     /* SPI Clock Prescalar Group Configurations */
     #define BG_SPI_PRESC_DIV2_GC   (SPI2X0)
     #define BG_SPI_PRESC_DIV4_GC   (0x00)
     #define BG_SPI_PRESC_DIV8_GC   (SPI2X0 | SPR00)
     #define BG_SPI_PRESC_DIV16_GC  (SPR00)
     #define BG_SPI_PRESC_DIV32_GC  (SPI2X0 | SPR10)
     #define BG_SPI_PRESC_DIV64_GC  (SPR10)
     #define BG_SPI_PRESC_DIV128_GC (SPR10 | SPR00)
